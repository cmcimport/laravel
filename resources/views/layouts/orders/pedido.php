        ...
        <div class="row">
          <div class="col-12">
            <div class="callout callout-info">
              <h5><i class="fas fa-info"></i> Ten en cuenta que:</h5>
              XXX no es mediador entre las transacciones realizadas ni cobra ninguna comisión por prestar el servicio. <br>A continuación puedes ver la información del vendedor
               o cliente, negociar los detalles de tu pedido y confirmar la operación. En XXX cuidamos que en nuestra red solo puedan participar usuarios legítimos.
            </div>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    <i class="fas fa-globe"></i> Nombre comercial del vendedor
                    <small class="float-right">#AZ999 - 2/10/2021</small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                  Datos del vendedor
                  <address>
                    <strong>Nombre legal de la empresa S.L.</strong><br>
                    Dirección completa y número, 48<br>
                    Ciudad, 28080<br>
                    Teléfono de contacto: 698698698<br>
                    Email: info@vendedor.com
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                ...
                <div class="col-sm-4">
                  <!-- Valora -->
                    <strong><i class="fas fa-heartbeat"></i> Valora este pedido, de ti depende su reputación</strong>
                         
                        <p class="text-muted">Las votaciones son anónimas y tienen un gran peso para calcular la reputación tanto de productos como de compradores y vendedores en nuestra red.
