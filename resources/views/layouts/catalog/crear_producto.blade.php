        ...
        <div class="container-fluid">
            <div class="card card-outline card-primary">
                ...
                <form role="form" method="POST" action="{{route('products.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="col-12 col-md-4">
                                        ...
                                        <div class="card-body">
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Nombre del producto">
                                          </div>
                                          <div class="form-group">
                                ...
                                <div class="col-12 col-md-5">   
                                    <div class="card-body">
                                        ...
                                        <textarea id="summernote" name="descripcion">
                                          <p>Escribe <em>aquí</em> tu <u>texto</u> <strong>personalizado</strong></p>
                                          <p>Puedes añadir estilos de letra, imágenes y otras opciones fácilmente</p>
                                        </textarea>
                                        <div class="card-footer">
                                            Escribe aquí la descripción del producto o servicio de forma detallada
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="card-body">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <input type="checkbox" class="form-check-input" id="envio" name="requiere_envio" value="1">
                                            <label class="form-check-label" for="envio">Puede requerir envío</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="hidden" class="form-check-input custom-control-input" name="recogida" value="0">
                                          <input type="checkbox" class="form-check-input" id="recogida" name="recogida" value="1">
                                          <label class="form-check-label" for="recogida">Recogida en tienda</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="hidden" class="form-check-input custom-control-input" name="precio_negociable" value="0">
                                          <input type="checkbox" class="form-check-input" id="precio_negociable" name="precio_negociable" value="1">
                                          <label class="form-check-label" for="precio_negociable">Precio negociable</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="hidden" class="form-check-input custom-control-input" name="mostrar_precio" value="0">
                                          <input type="checkbox" class="form-check-input" id="mostrar_precio" name="mostrar_precio" value="1">
                                          <label class="form-check-label" for="mostrar_precio">No mostrar precio</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="hidden" class="form-check-input custom-control-input" name="venta_al_por_mayor" value="0">
                                          <input type="checkbox" class="form-check-input" id="mayorista" name="venta_al_por_mayor" value="1">
                                          <label class="form-check-label" for="mayorista">Disponible al por mayor</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="hidden" class="form-check-input custom-control-input" name="requiere_instalacion" value="0">
                                          <input type="checkbox" class="form-check-input" id="instalacion" name="requiere_instalacion" value="1">
                                          <label class="form-check-label" for="instalacion">Se puede instalar</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="hidden" class="form-check-input custom-control-input" name="requiere_cita_previa" value="0">
                                          <input type="checkbox" class="form-check-input" id="cita_previa" name="requiere_cita_previa" value="1">
                                          <label class="form-check-label" for="cita_previa">Requiere cita previa</label>
                                        </div>
                                        <label>Precio</label>
                                        <input type="text" class="form-control" id="precio" name="precio" placeholder="Precio base en € IVA incluido">
                                    </div>
                                </div>
                                <!-- .FIN BLOQUE 3 -->
                    ...
                    <div class="card-footer">
                            <button type="submit" class="btn btn-primary right rightButton float-right">Publicar</button>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div><!-- /.card dark -->
